...
cd $HOME
git clone --branch release/${VERSION} $REPO
cd $PROJECT_FOLDER
make go.sum
make install
...
[Service]
User=$USER
ExecStart=$(which cosmovisor) run start --home $HOME/${SYSTEM_FOLDER}
Restart=on-failure
RestartSec=10
LimitNOFILE=65535
...
SNAPSHOT=https://fx-mainnet.s3.amazonaws.com/fxcore-pruned-snapshot-mainnet-2024-05-18.tar.gz
cp $HOME/$SYSTEM_FOLDER/data/priv_validator_state.json $HOME/$SYSTEM_FOLDER/priv_validator_state.json.backup
rm -rf $HOME/$SYSTEM_FOLDER/data/*
mv $HOME/$SYSTEM_FOLDER/priv_validator_state.json.backup $HOME/$SYSTEM_FOLDER/data/priv_validator_state.json
wget -c $SNAPSHOT
tar -xzvf fxcore-pruned-snapshot-mainnet-2024-05-18.tar.gz -C $HOME/$SYSTEM_FOLDER
rm -rf fxcore-pruned-snapshot-mainnet-2024-05-18.tar.gz
