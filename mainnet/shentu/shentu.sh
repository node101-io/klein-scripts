...
PROJECT=shentu
EXECUTE=shentud
RPC_URL=https://shentu-rpc.polkachu.com
...
GENESIS_FILE=https://snapshots.polkachu.com/genesis/shentu/genesis.json
ADDRBOOK=https://snapshots.polkachu.com/addrbook/shentu/addrbook.json
PORT=26
DENOM=uctk
GO_VERSION="1.21.9"
...
SNAPSHOT=https://snapshots.polkachu.com/snapshots/shentu/shentu_18498584.tar.lz4
