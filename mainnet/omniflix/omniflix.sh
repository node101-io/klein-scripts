...
EXECUTE=omniflixhubd
CHAIN_ID=omniflixhub-1
SYSTEM_FOLDER=.omniflixhub
PROJECT_FOLDER=omniflixhub
VERSION=v0.10.0
REPO=https://github.com/OmniFlix/omniflixhub.git
GENESIS_FILE=https://snapshots.polkachu.com/genesis/omniflix/genesis.json
ADDRBOOK=https://snapshots.polkachu.com/addrbook/omniflix/addrbook.json
PORT=26
DENOM=uflix
GO_VERSION=$(curl -L https://golang.org/VERSION?m=text | sed 's/^go//')
PEERS="574b37cc6e80663e70673cbe848147c2643ca48e@35.240.187.174:26656,ebc272824924ea1a27ea3183dd0b9ba713494f83@omniflixhub-mainnet-peer.autostake.com:27306,d8e371758cdb310906bc32ba0bb922642bb33536@65.21.91.99:26756"
...
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0.001$DENOM\"/" $HOME/$SYSTEM_FOLDER/config/app.toml
