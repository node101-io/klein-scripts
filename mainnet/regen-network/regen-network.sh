...
EXECUTE=regen
SYSTEM_FOLDER=.regen
PROJECT_FOLDER=regen-ledger
RPC_URL=https://regen-rpc.publicnode.com
...
GENESIS_FILE=https://raw.githubusercontent.com/regen-network/mainnet/main/regen-1/genesis.json
ADDRBOOK=http://snapshots.autostake.com/lyIs25DaSWMSm8evWKHGQrb/regen-1/addrbook.json
PORT=26
DENOM=uregen
...
SEEDS="ebc272824924ea1a27ea3183dd0b9ba713494f83@regen-mainnet-seed.autostake.com:27216"
...
SNAPSHOT=http://snapshots.autostake.com/lyIs25DaSWMSm8evWKHGQrb/regen-1/latest.tar.lz4
