...
PROJECT_FOLDER=xpla
VERSION=v1.2.2
REPO=https://github.com/xpladev/xpla.git
GENESIS_FILE=https://snapshots.polkachu.com/genesis/xpla/genesis.json
ADDRBOOK=https://snapshots.polkachu.com/addrbook/xpla/addrbook.json
PORT=26
DENOM=axpla
...
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"850000000000$DENOM\"/" $HOME/$SYSTEM_FOLDER/config/app.toml
