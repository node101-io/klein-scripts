...
EXECUTE=passage
CHAIN_ID=passage-1
SYSTEM_FOLDER=.passage
PROJECT_FOLDER=Passage3D
VERSION=v1.1.0
REPO=https://github.com/envadiv/Passage3D.git
GENESIS_FILE=https://snapshots.polkachu.com/genesis/passage/genesis.json
ADDRBOOK=https://snapshots.polkachu.com/addrbook/passage/addrbook.json
PORT=26
DENOM=upasg
