...
SYSTEM_FOLDER=.banksy
PROJECT_FOLDER=composable-testnet
VERSION=v3.0.3-testnet
REPO=https://github.com/notional-labs/composable-testnet.git
GENESIS_FILE=https://snapshots.kjnodes.com/composable-testnet/genesis.json
...
PEERS=$(curl -s https://ss-t.banksy.nodestake.top/peers.txt)
...
SNAPSHOT=https://snapshots.kjnodes.com/composable-testnet/snapshot_latest.tar.lz4
