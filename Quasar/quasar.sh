...
PROJECT_FOLDER=quasar-preview
VERSION=v0.1.1
REPO=https://github.com/quasar-finance/quasar-preview.git
GENESIS_FILE=https://snapshots.kjnodes.com/quasar/genesis.json
ADDRBOOK=https://snapshots.kjnodes.com/quasar/addrbook.json
PORT=26
DENOM=ibc
...
SNAPSHOT=https://snapshots.kjnodes.com/quasar/snapshot_latest.tar.lz4
