...
GENESIS_FILE=https://snapshots.polkachu.com/genesis/kujira/genesis.json
...
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0.00119$DENOM\"/" $HOME/$SYSTEM_FOLDER/config/app.toml
...
SNAPSHOT=https://snapshots.kjnodes.com/kujira/snapshot_latest.tar.lz4
